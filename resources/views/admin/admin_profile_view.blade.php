        ...
        <div class="row">
            ...
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-image">
                  <img class="rounded-circle" style="width:90px; height:90px;" src=" {{ (!empty($adminData->profile_image))? url('upload/admin_images/'. $adminData->profile_image): url('upload/no_img.jpg') }}">
